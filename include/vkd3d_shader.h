...
enum vkd3d_shader_parameter_name
{
     ...
     * fog.
     *
     * In order to emulate fixed-function pipelines which use start and end
     * coordinates, this value can be set to 1 / (end - start).
     *
     * The data type for this parameter must be
     * VKD3D_SHADER_PARAMETER_DATA_TYPE_FLOAT32.
     *
     ...
     * if the target environment does not support shade mode as part of its own
